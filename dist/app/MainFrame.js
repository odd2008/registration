...
var MainFrame = function (_React$Component) {
  ...
  function MainFrame() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MainFrame.__proto__ || Object.getPrototypeOf(MainFrame)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      mobileOpen: false,
      menuName: '用户管理'
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _styles.withStyles)(styles, { withTheme: true })((0, _reactRouterDom.withRouter)(MainFrame)));